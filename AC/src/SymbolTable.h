...
///////////////////////////// SYMBOL TABLE ITEM STRUCT

#define AC_MAX_SYMBOL_TABLE_KEY_SIZE 100

typedef struct AC_SymbolTableItem
{
	char key[AC_MAX_SYMBOL_TABLE_KEY_SIZE];
...
extern AC_SymbolTableItem *_ac_st_array[AC_MAX_HASH_ARRAY_SIZE];
...
// Implment just enough for the following statement:
// int value = 100;
